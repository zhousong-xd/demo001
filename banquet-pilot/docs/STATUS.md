...
Docs tip: after T-026 — product SHA frozen; playtest smoke + undo + c03 calm_bell; [`LESSONS.md`](./LESSONS.md) · [`CURRENT_PLAN.md`](./CURRENT_PLAN.md); PR #11 still draft.
...
| #32 | T-026 playtest c03 安心铃冒烟 | done / awaiting ACCEPT · 误投不扣 + 对兔有效；保留既有 smoke；不改 dist |
...
| Done (candidates) | **#32 / T-026** c03 calm_bell smoke | miss fox / hit rabbit; await ACCEPT |
