...
const script = sourcePaths.map(source => readFileSync(new URL(source, folder), "utf8")
  .replace(/^import .+;\r?$/gm, "")
...
const template = readFileSync(new URL("index.template.html", folder), "utf8");
const css = readFileSync(new URL("style.css", folder), "utf8");
const guests = readFileSync(new URL("guests.html", folder), "utf8");
