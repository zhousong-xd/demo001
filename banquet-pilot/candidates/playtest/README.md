...
Kernel-only check (no browser): `node candidates/playtest/smoke.mjs` from `banquet-pilot/` (T-024/T-025: c01–c12 load+place; c01/c04 undo; c03 bell; c02 swap; c01 displace).
